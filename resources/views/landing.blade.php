...
<head>
  ...
  <style>
    * {
    ...
    .hero {
      background: linear-gradient(135deg, #1A5C2A 0%, #276B35 100%);
      min-height: 88vh;
      display: flex;
      align-items: center;
      padding: 60px 40px;
...
<body>
  ...
  <section class="hero">
    ...
    <div class="hero-image">
      {{-- Uses asset() helper to link to public/images/hero.jpg [cite: 35, 192, 200] --}}
      <img src="{{ asset('images/hero-pic.jpg') }}" alt="Students at Gordon College" />
    </div>
  </section>
